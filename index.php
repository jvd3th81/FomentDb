...
<main class="row">
	<div class="col-sm-6 col-lg-2 "><?=$importacion?></div>
	<div class="col-sm-6 col-lg-2"><?=$alumno?></div>
	<div class="col-sm-6 col-lg-2"><?=$comercial?></div>
	<div class="col-sm-6 col-lg-2"><?=$busqueda?></div>
	<div class="col-sm-6 col-lg-2"><?=$exportacion?></div>
</main>
</html>