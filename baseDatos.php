...
########## BUSCADOR ACTUACIONES COMERCIALES ######################################################################
/*
	$fe = "";
	$us = "";
	$as = "";
...
if(isset($_POST['buscaLlamadas'])){ 
	...
	$fe = $_POST['FechaActuacion'];
	$us = $_POST['Usuario'];
	$as = $_POST['Asunto'];
	$de = $_POST['Destinatario'];
	$mo = $_POST['Movil'];
	$es = $_POST['Estado'];

}

$sql = "SELECT id, FechaActuacion, Usuario, Asunto, Destinatario, movil, Estado FROM LLamadas WHERE 
