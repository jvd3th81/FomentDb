...
$sql = "SELECT Id, NIF, NIE, PrimerApellido, Nombre, SegundoApellido, Expediente, Accion, Grupo, ActuacionComercial,
	...
	if($resultado->num_rows > 0){ 
				...
				$seleccion .= "<th>NIF</th>";
				$seleccion .= "<th>NIE</th>";				
				$seleccion .= "<th>1º&nbsp;Apellido</th>";
				$seleccion .= "<th>Nombre</th>";
				$seleccion .= "<th>2º&nbsp;Apellido</th>";
				$seleccion .= "<th>Expediente</th>";
				$seleccion .= "<th>Acción</th>";
				$seleccion .= "<th>Grupo</th>";
				$seleccion .= "<th>Actuación</th>";
				$seleccion .= "<th>Estado</th>";
				$seleccion .= "<th>Fecha</th>";
				$seleccion .= "<th>Email</th>";
				$seleccion .= "<th>Teléfono</th>";
				$seleccion .= "<th>Móvil</th>";
				$seleccion .= "<th>Colectivo</th>";
				$seleccion .= "<th>Responsable</th>";
				$seleccion .= "<th>Opciones</th>";
...
/*
	...
	$m = $_POST['modificar'];
	$sql = "UPDATE Alumno SET nombre='María' WHERE poblacion='Barcelona'";
	$conn2->query($sql);
...
$resultado = $conn2->query($sql);
	...
	$llamadas = "<table id='resultado'>";

	if($resultado->num_rows > 0){ 
				
				$llamadas .= "<th>Fecha</th>";
				$llamadas .= "<th>Responsable</th>";
				$llamadas .= "<th>Asunto</th>";				
				$llamadas .= "<th>Destinatario</th>";
				$llamadas .= "<th>Movil</th>";
				$llamadas .= "<th>Estado</th>";
...
$resultado = $conn2->query($sql);
	...
	$sms = "<table id='resultado'>";

	if($resultado->num_rows > 0){ 
				
				$sms .= "<th>Fecha</th>";
				$sms .= "<th>Responsable</th>";
				$sms .= "<th>Asunto</th>";				
				$sms .= "<th>Destinatario</th>";
				$sms .= "<th>Movil</th>";
				$sms .= "<th>Estado</th>";
...
$resultado = $conn2->query($sql);
	...
	$email = "<table id='resultado'>";

	if($resultado->num_rows > 0){ 
				
				$email .= "<th>Fecha</th>";
				$email .= "<th>Responsable</th>";
				$email .= "<th>Asunto</th>";				
				$email .= "<th>Destinatario</th>";
				$email .= "<th>Email</th>";
				$email .= "<th>Estado</th>";
...
$resultado = $conn2->query($sql);
	...
	$nl = "<table id='resultado'>";

	if($resultado->num_rows > 0){ 
				
				$nl .= "<th>Fecha</th>";
				$nl .= "<th>Responsable</th>";
				$nl .= "<th>Asunto</th>";				
				$nl .= "<th>Destinatario</th>";
				$nl .= "<th>Email</th>";
				$nl .= "<th>Estado</th>";
